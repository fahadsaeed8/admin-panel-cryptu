...
const pendingTrades: PendingTrade[] = []; // Will show "Data not found" like other pages
  ...
  return (
    <DashboardLayout>
      <div className="w-full">
        ...
        {/* 🟦 Heading (Same Style as Deposit History) */}
        ...
        <div className="bg-white rounded-lg shadow">
          <table className="w-full text-left border-collapse">
            ...
            {/* Show "Data not found" exactly like other upgraded pages */}
            <tbody>
              <tr>
                <td
                  colSpan={7}
